...
import { Plus, Trash2, MessageCircle, FileDown, CheckSquare, FileText } from 'lucide-react';
...
import { DispatchSheetModal } from './DispatchSheetModal';
...
const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [showDispatchSheet, setShowDispatchSheet] = useState<string | null>(null);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-center">
              ...
              <div className="lg:col-span-6 flex flex-wrap justify-between items-center gap-2">
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    onClick={() => setShowDispatchSheet(maquila.id)}
                    className="flex items-center gap-2 bg-purple-100 dark:bg-purple-900/30 px-3 py-2 rounded hover:bg-purple-200 dark:hover:bg-purple-800/50 text-purple-800 dark:text-purple-300"
                  >
                    <FileText size={18} />
                    Hoja de Despacho
                  </button>
            ...
            {selectedMaquilaId === maquila.id && (
              <div className="mt-4 border-t pt-4 dark:border-gray-700">
                <h4 className="font-semibold mb-3 text-gray-900 dark:text-white">Comentarios</h4>
                <div className="mb-4">
                  <textarea
                    value={newComment}
      ...
      {showDispatchSheet && (
        <DispatchSheetModal
          maquila={maquilas.find(m => m.id === showDispatchSheet)!}
          onClose={() => setShowDispatchSheet(null)}
        />
      )}
    </div>
  );
